...
public class AllPizzasAdapter extends BaseAdapter {
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup)
    {
        ...
        tv_items_name.setText("Item Name :"+pizzaPojos.get(pos).getItemname());
        ...
        btn_book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(cnt, "  "+pizzaPojos.get(pos).getItemname() +"  "+"order placed Successfullly " , Toast.LENGTH_LONG).show();
